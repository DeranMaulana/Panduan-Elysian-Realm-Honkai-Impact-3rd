...
<head>
  ...
  <title>Herrscher of Human - ER</title>
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#ultimate">Ultimate</a></li>
          <li><a class="nav-link scrollto" href="#charge">Charge</a></li>
  ...
  <main id="main">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="Aset/hoh/1.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="Aset/hoh/2.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="Aset/hoh/3.jpg" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Senjata : </strong>Bow <img src="Aset/Tipe Senjata/bows.png" width="35px" alt=""></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>Cara Bermain</h2>
              <p>
                Herrscher of Human memiliki 2 cara bermain di elysian realm, yaitu :
              </p>
              <p><b>Ultimate</b></p>
              <p><b>Charge ATK</b></p>
            </div>
    ...
    <section id="ultimate" class="bg-secondary">
      <div  class="cta">
        <div class="container">
          <div class="text-center">
            <br><h1>Ultimate Playstyle</h1>
            <!-- Icon Divider-->
     ...
     <div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
        ...
        <br><div class="row">
            ...
            <div class="col-4 border">
                <h1>Middle</h1>
                <img src="Aset/item/Pseudo_Miracle.png" alt="" width="100px">
                <img src="Aset/Item/The_Lonely_Moon.png" alt="" width="100px"><br>
                <img src="Aset/Chibi/Azure_Empyrea_Chibi_29.png" alt="">
                <img src="Aset/Chibi/Blood_Rose_Chibi_29.png" alt="">
            </div>
            <div class="col-4 border">
                ...
                <img src="Aset/item/Falling_in_Past_Light.png" alt="" width="100px"><br>
                <img src="Aset/Chibi/Azure_Empyrea_Chibi_29.png" alt="">
                <img src="Aset/Chibi/Blood_Rose_Chibi_29.png" alt="">
            </div>
        </div>
    ...
    <div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
        <div class="row center text-center">
            ...
            <div class="col-4 border mt-3">
                ...
                <h2>Blessing of first awakening</h2>
            </div>
            <div class="col-4 border mt-3">
                <h2 class="mt-4">Start</h2>
                <img src="Aset/Signet/Elysia.png" alt="">
                <h2>Blessing of Bloom</h2>
            </div>
            <div class="col-4 border mt-3">
                <h2 class="mt-4">Prioritas</h2>
                <img src="Aset/Signet/Elysia.png" alt="">
                <h2>Blessing of Journey</h2>
            </div>
        </div>
    </div>
    <div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
        <div class="row">
            ...
            <div class="col-3 border mt-3">
                <img src="Aset/Signet/Verve.png" alt="">
                <h2>Vill v2</h2>
            </div>
            <div class="col-3 border mt-3">
    ...
    <div class="container-fluid text-center text-secondary text-uppercase text-secondary bg-secondary">
        ...
        <div class="mt-4">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/FXK2tP3Z0CU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div><br>
    ...
    <!-- ======= Cta Section ======= -->
    <!-- End Cta Section -->
    <section id="charge" class="bg-secondary">
        <div class="cta">
            <div class="container">
                <div class="text-center">
                    <br><h1>Charge ATK Playstyle</h1>
                    <!-- Icon Divider-->
                    <div class="divider-custom text-white">
                        <div class="divider-custom-line"></div>
                        <div class="divider-custom-icon text-white"><i class="fas fa-star"></i></div>
        ...
        <div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
            <div class="row center text-center">
                ...
                <div class="col-6 border mt-3">
                    <h2 class="mt-4">start</h2>
                    <img src="Aset/Signet/Elysia.png" alt="">
                    <h2>Blessing of first encounter</h2>
                </div>
                <div class="col-6 border mt-3">
                    <h2 class="mt-4">Start</h2>
                    <img src="Aset/Signet/Elysia.png" alt="">
                    <h2>Blessing of first yearning</h2>
                </div>
            </div>
        </div>
        <div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
        ...
        <div class="container-fluid text-center text-secondary text-uppercase text-secondary bg-secondary">
            ...
            <div class="text-center text-white">
                <h2>Just hold the atk button</h2> <br>
            </div>
        </div>
    </section>
    <section id="komentar">
      ...
      <div class="container mt-4">
        <div class="card mx-auto" style="max-width:800px">
          ...
          <div class=" card-body p-4" style="height: 500px; overflow: auto;">
            <?php
            $query = "select * from komen_hoh ORDER BY kodekomen";
          ...
          <form action="php/proses_hoh.php" method="POST" class="signin-form">
            <br>
