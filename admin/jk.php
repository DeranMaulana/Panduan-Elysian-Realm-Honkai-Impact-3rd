    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="jk.php">JK</a></li>
      ...
      <tbody>
        <tr>
          ...
          while ($data = mysqli_fetch_array($result)) {
            ...
            <td><a href="proses/hapus_jk.php?kodekomen=<?php echo $data["kodekomen"]; ?>"><button type="button" class="btn btn-danger">Hapus</button></a></td>
          </tr>
          <?php
