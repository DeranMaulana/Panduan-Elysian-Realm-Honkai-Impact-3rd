...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="../../main.php"><img src="Aset/Signet/Elysia.png" alt=""> Elysian Realm</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#sword">Sword</a></li>
          <li><a class="nav-link scrollto" href="#dash">Dash</a></li>
          <li><a class="nav-link scrollto" href="#komentar">Komentar</a></li>
          <li class="dropdown"><a href="#"><span>Halo!
                <?php echo $_SESSION['nama']; ?>
              </span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="user/profile.php?username=<?php echo $_SESSION['username']; ?>">Profile</a></li>
  ...
  <main id="main">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="Aset/jk/1.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="Aset/jk/2.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="Aset/jk/3.jpg" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Tipe : </strong>PSY <img src="Aset/Tipe Battlesuit/psy.webp" width="35px" alt=""></li>
                <li><strong>Senjata : </strong>Fist / Gauntlet <img src="Aset/Tipe Senjata/fist.png" width="35px" alt=""></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>Cara Bermain</h2>
              <p>
                Jade Knight memiliki 2 cara bermain di elysian realm, yaitu :
              </p>
              <p><b>Sword Spam</b></p>
              <p><b>Dash Spam</b></p>
            </div>
    ...
    <section id="sword" class="bg-secondary">
      <div  class="cta">
        <div class="container">
          <div class="text-center">
            <br><h1>Sword Spam Playstyle</h1>
            <!-- Icon Divider-->
     ...
     <div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
        ...
        <br><div class="row">
            <div class="col-4 border">
                <h1>Start</h1>
                <img src="Aset/Item/Veil_of_Tears.png" alt="" width="100px">
            ...
            <div class="col-4 border">
                <h1>Middle</h1>
                <img src="Aset/Item/bodhi.png" alt="" width="100px">
                <img src="Aset/Item/The_Lonely_Moon.png" alt="" width="100px"><br>
                <img src="Aset/Chibi/Blood_Rose_Chibi_29.png" alt="">
                <img src="Aset/Chibi/Bright_Knight_-_Excelsis_Chibi_29.png" alt="">
            </div>
            <div class="col-4 border">
                <h1>Late</h1>
                <img src="Aset/Item/Rainbow_of_Absence.png" alt="" width="100px">
                <img src="Aset/Item/Dreamful_Gold.png" alt="" width="100px"><br>
                <img src="Aset/Chibi/Blood_Rose_Chibi_29.png" alt="">
                <img src="Aset/Chibi/Haxxor_Bunny_Chibi_29.png" alt="">
            </div>
        </div>
        <br>
    </div>
    ...
    <div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
        <div class="row center text-center">
            ...
            <div class="col-6 border mt-3">
                <h2 class="mt-6">start</h2>
                <img src="Aset/Signet/Elysia.png" alt="">
                <h2>Blessing of Great blade</h2>
            </div>
            <div class="col-6 border mt-3">
                <h2 class="mt-4">Start</h2>
                <img src="Aset/Signet/Elysia.png" alt="">
                <h2>Blessing of Cloudwalker</h2>
            </div>
        </div>
    </div>
    <div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
        <div class="row">
            ...
            <div class="col-3 border mt-3">
                <img src="Aset/Signet/Griseo.png" alt="">
                <h2>Griseo2</h2>
            </div>
            <div class="col-3 border mt-3">
            ...
            <div class="col-3 border mt-3">
                <img src="Aset/Signet/Mobius.png" alt="">
                <h2>Mobius1</h2>
            </div>
            <div class="col-3 border mt-3">
    ...
    <div class="container-fluid text-center text-secondary text-uppercase text-secondary bg-secondary">
        ...
        <div class="mt-4">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/Tgn3fSwEJNY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div><br>
    </section>
    <!-- ======= Cta Section ======= -->
    <!-- End Cta Section -->
    <section id="dash" class="bg-secondary">
        <div class="cta">
            <div class="container">
                <div class="text-center">
                    <br><h1>Dash Spam Playstyle</h1>
                    <!-- Icon Divider-->
                    <div class="divider-custom text-white">
                        <div class="divider-custom-line"></div>
                        <div class="divider-custom-icon text-white"><i class="fas fa-star"></i></div>
        ...
        <div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
        <br><h1 class="page-section-heading text-center text-uppercase text-white mb-0">Rekomendasi Emblem & Support</h1>
        <br>
        <div class="row">
            <div class="col-4 border">
                <h1>Start</h1>
            ...
            <div class="col-4 border">
                <h1>Middle</h1>
                <img src="Aset/Item/Gold_Goblet.png" alt="" width="100px">
                <img src="Aset/Item/The_Lonely_Moon.png" alt="" width="100px"><br>
                <img src="Aset/Chibi/Blood_Rose_Chibi_29.png" alt="">
                <img src="Aset/Chibi/Bright_Knight_-_Excelsis_Chibi_29.png" alt="">
            </div>
            <div class="col-4 border">
                <h1>Late</h1>
                <img src="Aset/Item/Tin_Flask.png" alt="" width="100px">
                <img src="Aset/Item/Dreamful_Gold.png" alt="" width="100px"><br>
                <img src="Aset/Chibi/Blood_Rose_Chibi_29.png" alt="">
                <img src="Aset/Chibi/Haxxor_Bunny_Chibi_29.png" alt="">
            </div>
        ...
        <div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
            <div class="row center text-center">
                ...
                <div class="col-6 border mt-3">
                    <h2 class="mt-4">start</h2>
                    <img src="Aset/Signet/Elysia.png" alt="">
                    <h2>Blessing of Shaft</h2>
                </div>
                <div class="col-6 border mt-3">
                    <h2 class="mt-4">Start</h2>
                    <img src="Aset/Signet/Elysia.png" alt="">
                    <h2>Blessing of Jade Moon</h2>
                </div>
            </div>
        </div>
        <div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
            <div class="row">
                <h1 class="mt-4">Signet Biasa</h1>
                <div class="col-3 border mt-3">
                    <img src="Aset/Signet/Aponia.png" alt="">
                    <h2>Aponia2</h2>
                </div>
                <div class="col-3 border mt-3">
                    <img src="Aset/Signet/Eden.png" alt="">
                    <h2>Eden2</h2>
                </div>
                <div class="col-3 border mt-3">
                    <img src="Aset/Signet/Hua.png" alt="">
      ...
      <div class="container mt-4">
        <div class="card mx-auto" style="max-width:800px">
          ...
          <div class=" card-body p-4" style="height: 500px; overflow: auto;">
            <?php
            $query = "select * from komen_jk ORDER BY kodekomen";
          ...
          <form action="php/proses_jk.php" method="POST" class="signin-form">
            <br>
            <div class="card-footer bg-white position-absolute w-100 bottom-0 m-0 p-1">
              <div class="input-group">
                ...
                <input type="text" name="kodekomen" class="form-control border-0" hidden>
                <input type="text" name="nama" value="<?php echo $_SESSION['nama']; ?>" class="form-control border-0" hidden>
                <div class="input-group-text bg-transparent border-0">
                </div>
                <div class="input-group-text bg-transparent border-0">
