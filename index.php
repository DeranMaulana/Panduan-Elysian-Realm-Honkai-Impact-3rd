...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.php"><img src="forms/Valkyrie/Aset/Signet/Elysia.png" alt=""> Elysian Realm</a>
      </h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class=nav-link scrollto href=forms/Login/login.php>Login</a></li>
          <!-- <?php
          session_start();
          if ($_SESSION['status'] != "login") {
            echo "<li><a class='nav-link scrollto' href=forms/Login/login.html>Login</a></li>";
          }
          ?> -->
        </ul>
        ...
        <div class="row gy-4 portfolio-container">
          ...
          <div class="col-xl-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <a href="forms/Valkyrie/6s.php" data-gallery="portfolio-gallery-app" class="glightbox"><img
                  src="assets/img/Valkyrie/6s.jpg" class="img-fluid" alt=""></a>
              <div class="portfolio-info">
                <h4><a href="forms/Valkyrie/6s.php" title="More Details">Sixth Serenade</a></h4>
              </div>
            </div>
          </div><!-- End Portfolio Item -->
          <div class="col-xl-4 col-md-6 portfolio-item filter-product">
            <div class="portfolio-wrap">
              <a href="forms/Valkyrie/HoTr.php" data-gallery="portfolio-gallery-app" class="glightbox"><img
                  src="assets/img/Valkyrie/hotr.jpg" class="img-fluid" alt=""></a>
              <div class="portfolio-info">
                <h4><a href="forms/Valkyrie/HoTr.php" title="More Details">Herrscher of Truth</a></h4>
              </div>
            </div>
          </div><!-- End Portfolio Item -->
          ...
          <div class="col-xl-4 col-md-6 portfolio-item filter-product">
            <div class="portfolio-wrap">
              <a href="forms/Valkyrie/JK.php" data-gallery="portfolio-gallery-app" class="glightbox"><img
                  src="assets/img/Valkyrie/sus.png" class="img-fluid" alt=""></a>
              <div class="portfolio-info">
                <h4><a href="forms/Valkyrie/JK.php" title="More Details">Jade Knight</a></h4>
              </div>
            </div>
          </div><!-- End Portfolio Item -->
          ...
          <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
            <div class="portfolio-wrap">
              <a href="forms/Valkyrie/HoH.php" data-gallery="portfolio-gallery-app" class="glightbox"><img
                  src="assets/img/Valkyrie/hoh.jpg" class="img-fluid" alt=""></a>
              <div class="portfolio-info">
                <h4><a href="forms/Valkyrie/HoH.php" title="More Details">Herrscher of Human</a></h4>
              </div>
            </div>
          </div><!-- End Portfolio Item -->
          ...
          <div class="col-xl-4 col-md-6 portfolio-item filter-books">
            <div class="portfolio-wrap">
              <a href="forms/Valkyrie/HoF.php" data-gallery="portfolio-gallery-app" class="glightbox"><img
                  src="assets/img/Valkyrie/hof.png" class="img-fluid" alt=""></a>
              <div class="portfolio-info">
                <h4><a href="forms/Valkyrie/HoF.php" title="More Details">Herrscher of Flamescion</a></h4>
              </div>
            </div>
          </div><!-- End Portfolio Item -->
          ...
          <div class="col-xl-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <a href="forms/Valkyrie/RC.php" data-gallery="portfolio-gallery-app" class="glightbox"><img
                  src="assets/img/Valkyrie/pardo.png" class="img-fluid" alt=""></a>
              <div class="portfolio-info">
                <h4><a href="forms/Valkyrie/RC.php" title="More Details">Reverist Calico</a></h4>
              </div>
            </div>
          </div><!-- End Portfolio Item -->
        </div>
