...
<head>
  ...
  <title>Reverist Calico - ER</title>
  ...
  <main id="main">
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="Aset/rc/1.jpg" alt="">
                </div>
                <div class="swiper-slide">
                    <img src="Aset/rc/2.png" alt="">
                  </div>
                  <div class="swiper-slide">
                    <img src="Aset/rc/3.jpg" alt="">
                  </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Elemen : </strong>Ice <img src="Aset/Tipe Damage/Core_Ice_DMG.webp" alt="" width="35px"></li>
                <li><strong>Tipe : </strong>IMG <img src="Aset/Tipe Battlesuit/imaginary.webp" alt="" width="35px"></li>
                <li><strong>Senjata : </strong>Chakrams <img src="Aset/Tipe Senjata/Chakrams.png" width="35px" alt=""></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>Cara Bermain</h2>
              <p>
                Sejauh ini Reverist Calico hanya memiliki 1 gaya bermain dengan memanfaatkan 2 signet elysia, yaitu :
              </p>
              <p><b>Blessing of Hidden Claws</b></p>
              <p><b>Blessing of Tailpiece</b></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <br><div class="row">
        <div class="col-4 border">
            <h1>Start</h1>
            <img src="Aset/Item/Feast_of_Emptiness.png" alt="" width="100px">
            <img src="Aset/Item/Awakening.png" alt="" width="100px"><br>
        ...
        <div class="col-4 border">
            <h1>Late</h1>
            <img src="Aset/Item/Good_Old_Days.png" alt="" width="100px">
            <img src="Aset/Item/Falling_in_Past_Light.png" alt="" width="100px"><br>
            <img src="Aset/Chibi/Azure_Empyrea_Chibi_29.png" alt="">
            <img src="Aset/Chibi/Haxxor_Bunny_Chibi_29.png" alt="">
        </div>
...
<div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
    <div class="row center text-center">
        ...
        <div class="col-6 border mt-3">
            ...
            <h2>Blessing of hidden claws</h2>
        </div>
        <div class="col-6 border mt-3">
            <h2 class="mt-4">Start</h2>
            <img src="Aset/Signet/Elysia.png" alt="">
            <h2>Blessing of the tailpiece</h2>
        </div>
    </div>
</div>
<div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
    <div class="row">
        ...
        <div class="col-3 border mt-3">
            <img src="Aset/Signet/Pardofelis.png" alt="">
            <h2>pardo1</h2>
        </div>
        <div class="col-3 border mt-3">
...
<div class="container-fluid text-center text-secondary text-uppercase text-secondary bg-secondary">
    ...
    <div class="mt-4">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/ezZLII02enc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div><br>
    <div class="text-center text-white">
        <h2>Youtube : abzie raptamema</h2> <br>
    </div>
</div>
  </section>
  <section id="komentar">
      ...
      <div class="container mt-4">
        <div class="card mx-auto" style="max-width:800px">
          ...
          <div class=" card-body p-4" style="height: 500px; overflow: auto;">
            <?php
            $query = "select * from komen_rc ORDER BY kodekomen";
          ...
          <form action="php/proses_rc.php" method="POST" class="signin-form">
            <br>
