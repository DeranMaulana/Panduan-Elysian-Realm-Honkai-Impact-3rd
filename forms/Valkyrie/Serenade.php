  ...
  <main id="main">
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="Aset/Valkyrie/6s.jpg" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Elemen : </strong>Ice <img src="Aset/Tipe Damage/Core_Ice_DMG.webp" alt="" width="35px">
                </li>
                <li><strong>Tipe : </strong>PSY <img src="Aset/Tipe Battlesuit/psy.webp" alt="" width="35px"></li>
                <li><strong>Senjata : </strong>Pistols <img src="Aset/Tipe Senjata/Pistols.png" width="35px" alt="">
                </li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>Cara Bermain</h2>
              <p>
                Sejauh ini Sixth Serenade hanya memiliki 1 gaya bermain dengan memanfaatkan 2 signet elysia, yaitu :
              </p>
              <p><b>Blessing of Nocturnal Tides</b></p>
              <p><b>Blessing of Tragedy</b></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="panduan" class="bg-secondary">
      ...
      <div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
        <br>
        <h1 class="page-section-heading text-center text-uppercase text-white mb-0 mt-4">Rekomendasi Emblem & Support
        </h1>
        <br>
        <div class="row">
          <div class="col-4 border">
            <h1>Start</h1>
            <img class="mx-auto img-fluid" src="Aset/Item/Veil_of_Tears.png" alt="" width="100px">
          ...
          <div class="col-4 border">
            ...
            <img class="mx-auto img-fluid" src="Aset/Item/Faraway_Ship.png" alt="" width="100px"><br>
            <img class="mx-auto img-fluid" src="Aset/Chibi/Azure_Empyrea_Chibi_29.png" alt="">
            <img class="mx-auto img-fluid" src="Aset/Chibi/Lightning_Empress_Chibi_29.png" alt="">
          </div>
        </div>
      ...
      <div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
        <div class="row center text-center">
          ...
          <div class="col-4 border mt-3">
            ...
            <h2>Blessing of Nocturnal tides</h2>
          </div>
          <div class="col-4 border mt-3">
            <h2 class="mt-4">Start</h2>
            <img class="mx-auto img-fluid" src="Aset/Signet/Elysia.png" alt="">
            <h2>Blessing of Tragedy</h2>
          </div>
          <div class="col-4 border mt-3">
            <h2 class="mt-4">Opsional</h2>
            <img class="mx-auto img-fluid" src="Aset/Signet/Elysia.png" alt="">
            <h2>Blessing of finale</h2>
          </div>
        </div>
      </div>
      <div class="container-fluid text-center text-white text-uppercase text-secondary bg-secondary">
        <div class="row">
          ...
          <div class="col-3 border mt-3">
            <img class="mx-auto img-fluid" src="Aset/Signet/Aponia.png" alt="">
            <h2>Aponia2</h2>
          </div>
          <div class="col-3 border mt-3">
      ...
      <div class="container-fluid text-center text-secondary text-uppercase text-secondary bg-secondary">
        ...
        <div class="mt-4">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/P-9dJHr3kdw" title="YouTube video player"
            frameborder="0"
      ...
      <div class="container mt-4">
        <div class="card mx-auto" style="max-width:800px">
          ...
          <div class=" card-body p-4" style="height: 500px; overflow: auto;">
            <?php
            $query = "select * from komen_6s ORDER BY kodekomen";
          ...
          <form action="php/proses_6s.php" method="POST" class="signin-form">
            <br>
